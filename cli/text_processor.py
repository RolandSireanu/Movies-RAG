...
STOP_WORDS = {
        ...
        "then", "there", "these", "they", "they'd", "they'll", "they're", "they've",
...
def preprocess_text(arg_text) -> str:
    ...
    arg_text_list = [word for word in arg_text_list if word not in STOP_WORDS]
    arg_text_list = [stemmer.stem(word) for word in arg_text_list]
    return arg_text_list